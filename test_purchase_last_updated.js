...
// Test making a purchase and checking if LASTUPDATED is updated
async function testPurchaseLastUpdated() {
  try {
    ...
    console.error('Error testing purchase last updated:', error.response?.data || error.message);
  }
}

testPurchaseLastUpdated();